...
// Text
export const text = {
  light: createPaletteChannel({ primary: COLORS.text.primary, secondary: COLORS.text.secondary, disabled: COLORS.text.disabled }),
...
export const background = {
  ...
  dark: createPaletteChannel({ paper: grey[800], default: COLORS.background.default, neutral: '#28323D' }),
};
